...
def args2dict(args):
    ...
    model_params = {"problem_size": args.problem_size, "pomo_size": args.pomo_size, "embedding_dim": args.embedding_dim, "sqrt_embedding_dim": args.sqrt_embedding_dim,
...
if __name__ == "__main__":
    ...
    # model_params
    parser.add_argument('--model_type', type=str, default="MOE", choices=["SINGLE", "MTL_ET", "MOE", "MOE_LIGHT"])
    ...
    parser.add_argument('--milestones', type=int, nargs='+', default=[4501, 5580, 5590, 5650, 5700, 5710, 5720, 5730, 5740,  5750, 5760, 5770, 5780, 5790, 5800], help='when to decay lr')
    ...
    parser.add_argument('--train_episodes', type=int, default=20000, help="the num. of training instances per epoch")
