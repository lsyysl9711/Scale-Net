...
if __name__ == "__main__":
    ...
    # model_params
    parser.add_argument('--model_type', type=str, default="MTL_ET", choices=["SINGLE", "MTL_ET" , "MOE"])
    ...
    # tester_params
    parser.add_argument('--checkpoint', type=str, default=None, help="load pretrained model to evaluate")
